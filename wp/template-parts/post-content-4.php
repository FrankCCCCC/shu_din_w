...
if (!theme_the_post()) return;
 $post0 = $post;
 ?>
<?php $skip_min_height = false; ?><section class="u-clearfix u-section-4" id="sec-8ea2">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <?php if ($post0 !== null) { ?><h2 class="u-blog-control u-expanded-width u-text u-text-1">
        ...
        <div class="u-metadata u-metadata-1">
          ...
          <?php if ($post0 !== null) { ?><?php if (comments_open()): ?><span class="u-meta-comments u-meta-icon"><a class="u-textlink" href="<?php echo get_comments_link(); ?>">
                                        <?php _e(sprintf(__('Comments (%d)', 'wp'), (int)get_comments_number())); ?>
                                   </a></span><?php endif; ?><?php } ?>
        </div>
        <?php if ($post0 !== null) { ?><div class="u-blog-control u-expanded-width u-post-content u-text u-text-2"><?php echo is_singular() ? theme_get_content() : theme_get_excerpt(); ?></div><?php } ?>
        <?php if ($post0 !== null) { ?><a href="<?php the_permalink(); ?>" class="u-blog-control u-link u-link-1"><?php _e(sprintf(__('Read more', 'wp'))); ?></a><?php } ?>
      </div>
    </section><?php if ($skip_min_height) { echo "<style> .u-section-4, .u-section-4 .u-sheet {min-height: auto;}</style>"; } ?>