...
?>
<?php
$metaGeneratorContent = 'Nicepage 2.26.5, nicepage.com';
$meta_generator = '';
...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'wp' ); ?></a>
    <?php if (!$pageBlog && !$pagePost || $pageBlog && !$headerHideBlog || $pagePost && !$headerHidePost) { ?>
    <header class="u-clearfix u-header u-white u-header" id="sec-80cb">
  <div class="u-clearfix u-sheet u-sheet-1">
    <?php
            ob_start();
            ?><nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
      <div class="menu-collapse" style="font-size: 1rem; letter-spacing: 0; font-weight: 700; text-transform: uppercase;">
        <a class="u-border-2 u-border-active-grey-10 u-border-hover-grey-10 u-border-no-left u-border-no-right u-border-no-top u-button-style u-custom-left-right-menu-spacing u-custom-padding-bottom u-custom-top-bottom-menu-spacing u-nav-link u-text-active-grey-10 u-text-body-color u-text-hover-grey-10" href="#">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'link_class' => 'u-border-2 u-border-active-grey-10 u-border-hover-grey-10 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-grey-10 u-text-body-color u-text-hover-grey-10',
                    'link_style' => 'padding: 10px 0;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-9faf-25',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => 'padding: 10px 0;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-9faf-26',
                    'submenu_item_class' => 'u-nav-item',
    ...
    <h3 class="u-text u-text-body-alt-color u-text-default u-text-1">
      <a class="u-btn u-button-style u-none u-text-body-color u-text-hover-grey-10 u-btn-1" href="[page_97319653]">Agricompiler</a>
    </h3>
  </div>
</header>
    <?php } ?>
